...
menu_button.addEventListener('click', function() {
    if (menu_button.style.height != "100%") {
        ...
        opt_buttons_div.style.animation = "opt-buttons-div-open .8s easeInOutQuart 0s 1 forwards";
        ...
        opt_buttons_div.style.animation = "opt-buttons-div-close .8s easeInOutQuart 0s 1 forwards";
